...
public class CarBookingController {
	...
	@DeleteMapping(path = "/cancelBooking/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = "/allCarsBetweenDates", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public List<Object> searchByNumber(@RequestBody CarBooking carBooking) {
		List<Object> cars = bookingService.viewCarsBetweenDate(carBooking.getStartDate(), carBooking.getEndDate());
		return cars;
	}
